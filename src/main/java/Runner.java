...
public class Runner {
    final static List<Plane> planes = Arrays.asList(
    ...
    final static  PassengerPlane planeWithMaxPassengerCapacity = new PassengerPlane("Boeing-747", 980, 16100, 70500, 242);
